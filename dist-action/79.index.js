...
async function ask() {
    ...
    try {
        ...
        const useLlmProxy = await askBool('Are you using llm-proxy locally for Anthropic/Gemini? (free via Claude Max / Gemini Pro subscriptions)', false);
        console.log('');
